...
function changeWidths(){
    ...
    changeElementSizeAndLocation(gameImgs[gameImgs.length-1], arcadeImg, 0.5, imgSqSize * 1.8/arcadeBGW, 
        (xStartOffset + 2.165 * (imgSqSize + margins))/(imgSqSize * 1.8), (yStartOffset + 3.05 * (imgSqSize + margins))/(imgSqSize * 1.8));
